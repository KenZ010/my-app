...
export default function LoginPage() {
  ...
  const [passFocused, setPassFocused] = useState(false); // ← add this
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border rounded-lg px-4 py-3 text-sm mt-1 outline-none text-gray-900 pr-16 transition-colors ${passFocused ? "border-indigo-400" : "border-gray-200"}`}
                />
                <button
