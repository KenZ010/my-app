...
const handleLogin = async () => {
  ...
  try {
    ...
    if (data.token) {
      ...
      // Save token to cookie (for middleware) and localStorage (for api.ts getToken)
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      {/* TOP/LEFT - Green branded section */}
      <div
        className="w-full md:w-1/2 flex items-center justify-center relative overflow-hidden py-16 md:py-0 md:min-h-screen"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 z-10">
          <div className="w-28 h-28 md:w-44 md:h-44 rounded-full overflow-hidden border-0 relative shadow-2xl">
            <Image src="/logo-new.png" alt="Logo" fill className="object-cover" sizes="(max-width: 768px) 112px, 176px" />
          </div>
          <p className="text-white text-lg md:text-xl font-bold tracking-widest drop-shadow-lg">SOFTDRINKS STORE</p>
          <p className="text-green-200 text-xs tracking-wider opacity-80">Your favorite drinks, anytime.</p>
        </div>
      </div>

      {/* RIGHT/BOTTOM - Login form */}
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-10 md:py-12 bg-gradient-to-br from-gray-50 to-white min-h-screen relative">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                ...
                <div
                  className="flex items-center border-2 rounded-xl px-4 py-3 transition-all duration-200 bg-gray-50/50"
                  style={{
                    borderColor: userFocused ? "#4f46e5" : "#e5e7eb",
                    boxShadow: userFocused ? "0 0 0 3px rgba(79,70,229,0.1)" : "none",
                  }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                  <input
                    type="text"
                    value={username}
              ...
              <div>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                  <input
              ...
              <button
                onClick={handleLogin}
                disabled={loading}
                className="w-full py-3 rounded-xl text-white text-sm font-semibold mt-2 transition-all duration-200 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                style={{
                  background: loading
